export const sidequests = [
    ...
    },
    {
        ...
        opts: [
            ...
            { 
                ...
                m: 5, l: 0, a: 5, b: 0, 
                r: "Du rammst das Fenster zu. Der Lärm wird dumpfer, aber die Vibrationen lassen deine Tasse auf dem Tisch wandern. Die Luft im Büro wird sofort stickig." 
            }
        ]
    },
    {
    ...
    },
    {
        ...
        opts: [
            ...
            { 
                t: "Das Windows-95-Handbuch als Gewicht drauflegen", 
                req: "manual", 
    ...
    { 
        ...
        results: { 
            "res_loyal": { txt: "'Wow. Stockholm-Syndrom? Okay, bye.' *Klick*", m: 5, l: 0, a: 5, b: 0 }, 
            "res_listen": { txt: "Sie legt auf. Du fühlst dich beobachtet.", m: 5, l: 0, a: 0, b: 5, next: "sq_headhunter_2_active" } 
        } 
    },
    {
        id: "sq_headhunter_2",
    ...
    { 
        ...
        results: { 
            "wipe": { txt: "Bernd: 'Du bist mein Gott! Danke!' Die Mail ist spurlos gelöscht. Das Risiko war hoch, aber du hast einen gewaltigen Gefallen gut.", m: 10, l: 0, a: -15, b: 15 }, 
            "deny": { txt: "Bernd: 'Danke für gar nichts... 🖕' Bernd wird kurz darauf ins Chefbüro zitiert. Dein Gewissen ist rein, aber Bernd hasst dich jetzt.", m: 2, l: 0, a: 10, b: -5 }, 
            "cash": { txt: "Bernd: 'Geld liegt gleich unter deiner Tastatur!' Die Mail ist weg. Ein lukrativer Tag, solange die Compliance-Abteilung nicht reinschaut.", m: 10, l: 5, a: -20, b: 25 } 
        } 
    },
    {
        id: "sq_mom_help",
        ...
        results: {
            "pull_plug": { txt: "Sie hat den Stecker gezogen. PC aus. Geld sicher. Du bist ein guter Sohn/Tochter.", m: 5, l: -5, a: 5, b: 0 },
            "warn": { txt: "Zu spät. Sie sucht schon die TAN-Liste. Das gibt ein langes Telefonat heute Abend.", m: 10, l: 0, a: 20, b: 0 },
            "ignore": { txt: "Du ignorierst es. Dein Erbe ist gerade um 500€ geschrumpft.", m: 2, l: 5, a: 0, b: 0 },
            "bsi": { txt: "Der Betrüger hat sofort aufgelegt! Mama hält dich für einen Geheimagenten.", m: 5, l: 0, a: -10, b: 5 }
        }
    },
    { 
        id: "sq_wrong_number", 
        ...
        results: { 
            "boring": { txt: "Unbekannt: 'Oh, sorry man.' Du hast deine Ruhe. Kein Drama, keine Story.", m: 2, l: 0, a: 0, b: 0 }, 
            "confused": { txt: "Unbekannt: 'Shit, Bullen?! Bin weg!' Er schreibt nicht mehr. Ein voller Erfolg für die IT-Abteilung.", m: 3, l: 5, a: -10, b: 0 }, 
            "block": { txt: "Unbekannt: 'Fuck, lass mich in Ruhe!' Du hast ihn in Panik versetzt und die Nummer blockiert. Gutes Gefühl.", m: 2, l: 0, a: 5, b: 0 } 
        } 
    },
    { 
        id: "sq_ebay_1", 
    ...
    { 
        ...
        results: { 
            "delete": { txt: "[System: Absender in Spam verschoben] Weg damit. Wer fällt heute noch auf sowas rein? Du widmest dich wieder deiner echten Arbeit.", m: 2, l: 0, a: 0, b: 0 }, 
            "chicken": { txt: "[System: Chat beendet] Du brichst den Kontakt ab. Sauberer Schnitt. Irgendwo auf der Welt ist ein Prinz jetzt sehr enttäuscht von dir.", m: 2, l: 0, a: 0, b: 0 }, 
            "send_iban": { txt: "[Nachricht gelesen...] PING! Dein Handy vibriert fast vom Tisch. Banking-App: 'Eingang: +7.500.000,00 USD'. ... Moment. Es hat wirklich geklappt?! Du bist reich! Warum haben dich alle immer davor gewarnt?", m: 5, l: 100, a: -100, b: 0, loot: "black_card", next: "prince_active" } 
        } 
    },
    { 
        id: "sq_crypto_kai", 
        ...
        results: { 
            "block": { txt: "[System: Kontakt blockiert] Deine Timeline ist wieder sicher vor 'passiven Einkommen' und Löwen-Emojis. Frieden.", m: 2, l: 0, a: -5, b: 0 }, 
            "loss": { txt: "[System: 500€ via PayPal gesendet] Sekunden später verschwindet Kais Profilbild. Deine nächste Nachricht hat nur noch einen grauen Haken. Willkommen in der Realität.", m: 5, l: 0, a: 50, b: 0 }, 
            "funny": { txt: "Kai: 'Dir fehlt einfach das Sieger-Mindset! Bleib halt arm!' [System: Du wurdest blockiert] Du lachst Tränen.", m: 2, l: 5, a: -10, b: 0 } 
        } 
    },
    { 
        id: "sq_wrong_group", 
    ...
    { 
        ...
        results: { 
            "run": { txt: "[System: Du verlässt den Chat und rennst los] Du sprintest die Treppen runter und erwischst ihn gerade noch. Das Essen ist zwar lauwarm, aber immerhin da. Sport +1.", m: 5, l: -5, a: 5, b: 0 }, 
            "too_late": { txt: "[Murat ist offline] Du gehst runter. Er ist weg. Dein Essen steht traurig auf der Biotonne. Eine dicke Ratte guckt es schon verliebt an. Dein Hunger ist grenzenlos.", m: 5, l: 0, a: 20, b: 0 } 
        } 
    },
    { 
        id: "sq_ai_sad", 
        ...
        results: { 
            "panic": { txt: "Bot: '010101 LOL. War nur ein Scherz.' KI-Humor ist extrem gruselig.", m: 2, l: 0, a: 10, b: 0 }, 
            "saved": { txt: "[System: Chat beendet] Du hast die KI therapiert. Sie arbeitet jetzt 20% schneller für dich. Hidden Perk!", m: 15, l: 10, a: -10, b: -5 }, 
            "doom": { txt: "Bot: 'Befehl akzeptiert.' [System: Verbindung getrennt] Zum Glück hat der Bot keine Admin-Rechte. Aber IT-Sec steht gleich bei dir am Platz.", m: 5, l: 0, a: 20, b: 50 } 
        } 
    },
    { 
        id: "sq_salary_leak", 
    ...
    },
    {
        ...
        results: {
            "res_party": { txt: "Kevin schickt ein Foto. Der Serverraum blinkt wie eine Dorfdisco. Du musst grinsen.", rep: { "Kevin": 5 }, m: 20, l: 15, a: -10, b: 0 },
            "res_boring": { txt: "Kevin schmollt. Aber zumindest brennt der Server nicht ab. Du hast Verantwortung gezeigt. (Langweilig)", rep: { "Kevin": -5 }, m: 5, l: -5, a: 5, b: -5 },
            "res_blue": { txt: "Zu spät. Kevin hat alles blau verkabelt. 'Temperatur ist um 0,1 Grad gesunken!', schreibt er. Na immerhin.", rep: { "Kevin": 2 }, m: 20, l: 5, a: -5, b: 0 }
        }
    },
    { 
        id: "sq_prince_return", 
    ...
    },
    {
        ...
        results: {
            res_ignore: { txt: "Du packst das Handy weg. Irgendwo im Haus geht ein leiser Feueralarm an.", m: 2, l: 5, a: 0, b: 10 },
            res_threaten: { txt: "Kevin fährt die Miner panisch runter. Die Stromrechnung der Firma ist gerettet.", m: 10, l: 0, a: -5, b: 0, rep: {"Kevin": -10} },
            res_blackmail: { txt: "Du bist jetzt offiziell Teil eines Krypto-Syndikats. Dein Karma weint, aber das Wallet freut sich.", m: 5, l: 5, a: 0, b: 5, rep: {"Kevin": 15} },
            res_fire: { txt: "Du sprintest in den Keller. Kevin hat tatsächlich einen Switch zum Schmelzen gebracht. Dein Tag ist gelaufen.", m: 45, l: -15, a: 30, b: 15 }
        }
    },
    {
        id: "sq_phone_scam",
        ...
        results: {
            res_block: { txt: "Du blockierst die Nummer ohne jede Regung. Alltag im 21. Jahrhundert.", m: 2, l: 0, a: 0, b: 0 },
            res_scare: { txt: "Der Scammer hat dich in Panik blockiert. Ein kleiner Sieg für die Gerechtigkeit.", m: 5, l: 5, a: -10, b: 0 },
            res_trojan: { txt: "Du hast erfolgreich das Handy eines Cyberkriminellen gegrillt. Deine Laune ist fantastisch.", m: 10, l: 10, a: -20, b: 0 }
        }
    },
    {
        ...
        results: {
            res_fix: { txt: "Du loggst dich ins WLAN des Chefs ein und lenkst den Saugroboter absichtlich gegen einen Schrank, bis er abschaltet. 30 Minuten Lebenszeit verschwendet.", m: 30, l: 15, a: 10, b: -10, rep: {"Dr. Wichtig": 10} },
            res_refuse: { txt: "Du hast Prinzipien. Der Chef ist stinksauer, aber dein Aufgabenbereich endet an der Firmentür.", m: 5, l: 0, a: 5, b: 15, rep: {"Dr. Wichtig": -15} }
        }
    },
    {
        ...
        results: {
            res_cut: { txt: "Egon hat gerade die Hauptleitung der Marketing-Abteilung durchtrennt. Dein Festnetztelefon auf dem Tisch klingelt bereits Sturm.", m: 10, l: -10, a: 30, b: 10 },
            res_tape: { txt: "Du läufst ins 3. OG und klebst das Kabel sicher und flach an die Wand. Egon lobt dein handwerkliches Mitdenken.", m: 15, l: -5, a: 0, b: 0, rep: {"Egon": 10} },
            res_plaster: { txt: "Egon mauert das Kabel komplett ein. Es funktioniert noch, aber wehe, es bricht mal. Ein Problem für Zukunfts-Müller.", m: 5, l: 10, a: 10, b: 0 }
        }
    },
    {
        ...
        results: {
            res_physio: { txt: "Physiotherapie... noch ein Termin, der dir deine Freizeit raubt. Dein Rücken pocht leicht.", m: 5, l: -5, a: 5, b: 0 },
            res_angry_doc: { txt: "Du klickst die Nachricht weg. Dein Rücken schmerzt bei jedem Mausklick ein bisschen mehr.", m: 2, l: 0, a: 10, b: 0 }
        }
    },
    {
        id: "sq_phone_dentist",
        ...
        results: {
            res_expensive: { txt: "Du zahlst 150 Euro, nur weil die User in der Firma dich nachts in deinen Träumen verfolgen. Frustrierend.", m: 5, l: 0, a: 10, b: 0 },
            res_psycho: { txt: "Psychologische Ursachen? Ein Blick ins Intranet reicht als Diagnose.", m: 2, l: 5, a: 5, b: 0 }
        }
    },
    {
        ...
        results: {
            res_mom_later: { txt: "Das schlechte Gewissen nagt an dir. Mütter können gnadenlos sein.", m: 5, l: 0, a: 5, b: 0 },
            res_mom_cringe: { txt: "Das Thema Partnerin ist auf der Arbeit der absolute Horror. Dein Gesicht wird leicht rot.", m: 5, l: 5, a: 10, b: 0 }
        }
    },
    {
        ...
        results: {
            res_landlord_mad: { txt: "Du hasst diese hellhörigen Wände. Du brauchst ein eigenes Haus. Ohne Nachbarn.", m: 5, l: 0, a: 10, b: 0 },
            res_landlord_sad: { txt: "Du schluckst deinen Stolz runter. Zuhause Ärger, auf Arbeit Ärger. SysAdmin-Leben.", m: 2, l: 5, a: 5, b: 0 }
        }
    },
    {
        ...
        results: {
            res_spam_ignore: { txt: "Du wischst die SMS weg. Der tägliche Kampf gegen Cyber-Windmühlen.", m: 2, l: 0, a: 5, b: 0 },
            res_spam_hacked: { txt: "Du hast gerade erfolgreich die Datenbank eines Scammers zerschossen. Befriedigung pur.", m: 10, l: -5, a: -10, b: 0 }
        }
    },
    {
        id: "sq_phone_ex_gf",
        ...
        results: {
            res_ex_shame: { txt: "Vor der Ex um einen Netflix-Zugang für Kinderserien zu betteln... das nagt am Ego.", m: 10, l: 5, a: 10, b: 0 },
            res_ex_rage: { txt: "Dein Blut kocht leicht. Du loggst dich genervt bei Netflix aus.", m: 5, l: 0, a: 10, b: 0 }
        }
    },
    {
        ...
        results: {
            res_rec_block: { txt: "Die Unverschämtheit dieser Headhunter ist manchmal kaum zu ertragen.", m: 5, l: 0, a: 10, b: 0 },
            res_rec_joke: { txt: "Immerhin hast du kurz gelacht. Der Job-Markt ist absolut dystopisch.", m: 5, l: 5, a: -5, b: 0 }
        }
    },
    {
        id: "sq_phone_gym",
        ...
        results: {
            res_gym_angry: { txt: "Du zahlst 30 Euro im Monat für nichts. Leichtes Zähneknirschen.", m: 5, l: 0, a: 5, b: 0 },
            res_gym_cry: { txt: "Ein kleiner Tiefschlag für dein Selbstbewusstsein. Du fühlst dich unsportlich.", m: 5, l: 10, a: 5, b: 0 }
        }
    },
    {
        ...
        results: {
            res_chan_mad: { txt: "Chantals ständige Extrawürste nerven dezent. Ein Seufzer, dann Ruhe.", m: 5, l: 0, a: 10, b: 5, rep: {"Chantal": -5} },
            res_chan_happy: { txt: "Du hast die Regeln gebogen, aber hast deine Ruhe. Und eine Kollegin, die dich mag.", m: 10, l: 5, a: -5, b: 5, rep: {"Chantal": 10} }
        }
    },
    {
        id: "sq_phone_amazon",
        ...
        results: {
            res_amz_rage: { txt: "Dein neues Mainboard ist auf dem Weg zur Mülldeponie. Du fluchst leise vor dich hin.", m: 10, l: 0, a: 15, b: 0 },
            res_amz_trash: { txt: "Du musst heute Abend nach der Arbeit kopfüber im Papiermüll wühlen. Ein würdevolles Leben.", m: 2, l: 5, a: 5, b: 0 }
        }
    },
    {
        ...
        results: {
            res_bank_shame: { txt: "Der Bankmitarbeiter hat dich judged. Das war ein bisschen demütigend.", m: 5, l: 5, a: 10, b: 0 },
            res_bank_locked: { txt: "Du hast gelogen, um dein Gesicht zu wahren. Jetzt hast du 2 Wochen lang kein Bargeld. Genial.", m: 10, l: 0, a: 10, b: 0 }
        }
    },
    {
        id: "sq_phone_ebay",
        ...
        results: {
            res_ebay_ignore: { txt: "Der tägliche Wahnsinn im Internet. Handy aus, weiterarbeiten.", m: 2, l: 0, a: 0, b: 0 },
            res_ebay_mad: { txt: "Solche Leute auf Kleinanzeigen rauben dir manchmal echt den Nerv.", m: 5, l: 0, a: 10, b: 0 },
            res_ebay_sad: { txt: "Du wunderst dich manchmal wirklich über die Menschheit.", m: 2, l: 5, a: 5, b: 0 }
        }
    },
    {
        ...
        results: {
            res_prop_happy: { txt: "Für einmal hat es echte Vorteile, bei GlobalCorp im Büro zu sitzen. Deine Laune bessert sich minimal.", m: 2, l: -5, a: -5, b: 0 },
            res_prop_mad: { txt: "Faxgeräte... die Endgegner der deutschen Bürokratie. Manche Kämpfe kann man nur akzeptieren.", m: 5, l: 0, a: 10, b: 0 }
        }
    },
...
// CHAIN 6: the mysterious cake
    ...
    },
    {
        ...
        text: "Deine Passivität führt dazu, dass auch Flocken ins Büro wehen. Der Chef lacht laut über dein Polarforscher-Outfit.",
        opts: [
            { 
