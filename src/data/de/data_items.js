...
export const items = {
    ...
    "manual": { icon: "📖", name: "Windows-95-Handbuch", flavor: "'Das heilige Buch der Vorväter. Eignet sich auch als Monitor-Stütze. Die Seiten kleben zusammen, aber das Wissen darin ist absolut zeitlos.'", keep: true, img: "assets/img/items/manual.webp" },
