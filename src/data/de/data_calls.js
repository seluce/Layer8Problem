export const calls = [

	{
		...
		results: {
			res_solved: { txt: "Der Stecker war draußen, das Ticket ist zu, eine Entschuldigung kam nicht. Die Bilanzen gehen pünktlich raus, und niemand in der Buchhaltung wird je erfahren, wie knapp es war.", m: 5, l: 0, a: 5, b: 0 },
			res_fire: { 
	...
	},
	{
		...
		results: {
			truth: { txt: "Egon brummt kurz, dann: 'Wusste ich's doch. Kaffee.' Man hört ihn schon im Treppenhaus, den Werkzeugkoffer in der Hand und eine Ansprache über Flüssigkeiten am Arbeitsplatz auf den Lippen. Frau Meyer wird sie vollständig hören.", rep: { "Egon": 5 }, m: 5, l: 5, a: -5, b: 0 },
			lie: { txt: "Du nimmst die Schuld auf dich. Egon führt dich ab sofort als Elektro-Vandalen, dafür steht eine Stunde später eine Pralinenschachtel ohne Karte auf deinem Tisch. Frau Meyer weiß, was sie an dir hat. Egon leider auch.", rep: { "Egon": -5 }, m: 10, l: 0, a: -10, b: 10, loot: "donut" }
		}
	},
	{
		id: "call_kevin",
	...
	},
	{
		...
		opts: [
			{ t: "Mit Panzertape fixen", req: "tape", rep: { "Markus": 5 }, m: 15, l: -5, a: -5, b: -5, r: "Du hast die Papierkassette mit Tape festgeklebt. Es hält... vorerst. Markus grunzt zufrieden." },
			{ t: "Ist Papier im Drucker?", rep: { "Markus": -3 }, m: 10, l: -5, a: 20, b: -5, r: "Nein, war keins drin. Er entschuldigt sich natürlich nicht, sondern sagt: 'Das ist Ihre Aufgabe!'" },
			{ t: "PDF per Mail senden", rep: { "Markus": -5 }, next: "path_markus_papier", m: 5, l: 10, a: 0, b: 5, r: "Er versteht nicht, wie das geht. 'Ich will Papier!!' Du legst genervt auf." }
		]
	},
	{
		id: "call_sekretary_1",
		...
		opts: [
			{ t: "Vortrag halten", next: "call_sekretary_rage", rep: { "Gabi": -10 }, r: "Du erklärst ihr den Unterschied zwischen Lasertrommel und Fixiereinheit. Ihre Augenbraue zuckt gefährlich.", m: 10, l: -5, a: 10, b: 0 },
			{ t: "Donut anbieten", req: "donut", rep: { "Gabi": 10 }, r: "Du opferst deinen Notfall-Donut. Gabi beißt rein, ihr Blutzucker steigt, die Wut sinkt. Der Drucker ist immer noch kaputt, aber sie ignoriert es jetzt.", m: 10, l: 10, a: -20, b: 5 },
			{ t: "Aufschrauben", req: "screw", next: "call_sekretary_cable", rep: { "Gabi": 5 }, r: "Du öffnest die Wartungsklappe. Eine Büroklammer und drei Gummibärchen blockieren die Walze. Du holst sie raus. 'So, geht wieder!' ... Denkste.", m: 15, l: -5, a: 0, b: 0 }
		]
	},
	{
		...
		opts: [
			{ t: "WLAN-Antenne basteln", req: "tape", rep: { "Gabi": -5 }, r: "Du versuchst, aus einer Büroklammer und Tape eine Antenne zu bauen. Gabi fragt, ob du noch ganz dicht bist. Es funktioniert natürlich nicht.", m: 20, l: 0, a: 15, b: 5 },
			{ t: "Neues Kabel legen", req: "cable", rep: { "Gabi": 5, "Chantal": 5 }, r: "Zack. Kabel rein. Grüne LED. Der Drucker spuckt sofort 50 Seiten 'Wichtige Akten' aus. Gabi schaut dich an wie einen Halbgott.", m: 2, l: -5, a: -10, b: -5 },
			{ t: "Chantal suchen", rep: { "Chantal": -10, "Gabi": -5 }, r: "Du rennst durchs Haus, findest Chantal, streitest dich um das Kabel, kommst zurück. Gabi hat in der Zwischenzeit den Stecker gezogen. 'Jetzt ist er aus. Auch gut.'", m: 30, l: -10, a: 20, b: 10 }
		]
	},
	{
		...
		opts: [
			{ t: "Putzen helfen", rep: { "Gabi": 10 }, r: "Du versuchst, den Toner wegzuwischen. Er schmiert nur noch mehr. Nach einer Stunde sehen ihr beide aus wie Bergarbeiter. Aber das schweißt zusammen.", m: 60, l: -20, a: -5, b: 0 },
			{ t: "Erklären, dass Toner giftig ist", rep: { "Gabi": -15 }, r: "Gabi fängt an zu weinen. Dann zu schreien. Der Sicherheitsdienst begleitet dich raus.", m: 10, l: 0, a: 50, b: 20 },
			{ t: "Hustend das Weite suchen", rep: { "Gabi": -10 }, r: "Du fliehst hustend. Gabi wirft dir den leeren Toner hinterher. Du hinterlässt schwarze Fußabdrücke im Flur.", m: 5, l: 0, a: 20, b: 10 }
		]
	},
		{
			id: "call_egon",
	...
	},
	{
		...
		results: {
			res_tunnel: { txt: "Er hat die Tunnel-Ausrede geschluckt, aber sein Ton war eine Etage schärfer als beim letzten Mal. Du arbeitest ab jetzt gegen einen Countdown, den nur er kennt.", m: 10, l: 0, a: 10, b: 0 },
			res_respect: { txt: "Ein Choleriker, der Widerworte belohnt: Das erlebt man einmal im Berufsleben. Du notierst dir Datum und Uhrzeit. Bezeugen kann es leider niemand.", m: 20, l: 5, a: -10, b: -10 }
		}
	},
		{
			id: "call_chantal",
		...
		},
		{
			...
			opts: [
				{ t: "Erklären, dass RAM Hardware ist", m: 20, l: -5, a: 10, b: 0, r: "In seinen Augen bist du eine Fehlbesetzung. 'Im Internet steht, man kann das downloaden!'" },
				{ t: "Fake-Download starten", m: 10, l: 15, a: -5, b: 5, r: "Du öffnest einen Ladebalken. Er ist zufrieden und wartet." }
			]
		},
		{
			id: "call_schmidt",
		...
		results: {
			restart: { txt: "Sie startet neu. Der Rechner ist von 2009, und während er nachdenkt, erzählt Oma vom Kaninchen der Nachbarin. Nach 45 Minuten ist der Bildschirm wieder da, und du weißt alles über das Kaninchen.", m: 45, l: -10, a: 15, b: 0 },
			pull_plug: { 
				txt: "Oma zieht den Stecker. Plötzlich geht in DEINEM Büro das Licht aus.", 
				m: 5, l: 0, a: 20, b: 0,
				next: "grandma_darkness"
			},
			res_bad_grandson: { txt: "Du legst auf. Im Hintergrund war noch ihr 'Aber Junge...' zu hören. Der Fernseher bleibt jetzt bis Weihnachten kaputt, und genau so lange wird sie es jedem erzählen. Du kennst die Familie.", m: 2, l: 5, a: 5, b: 10 }
		}
	},
	{
		id: "call_grandma_2",
		...
		results: {
			lie_hacker: { txt: "Egon glaubt an Cyber-Krieg. Er bewaffnet sich mit einem Besen.", m: 10, l: 0, a: -5, b: 5 },
			truth_oma: { txt: "Egon lacht. 'Grüß sie schön.' Er macht den Strom wieder an.", rep: { "Egon": 5 }, m: 10, l: 5, a: -15, b: 0 }
		}
	},
	{
		id: "call_auditor",
	...
	},
	{
		...
		opts: [
			{ t: "Kalt abservieren: 'Kein Backup, kein Mitleid'", m: 2, l: 5, a: -5, b: 0, r: "Du legst auf. Das Weinen verstummt. Du fühlst dich kurz schlecht, dann trinkst du Kaffee." },
			{ t: "Professionelle Datenrettung", m: 90, l: -30, a: 10, b: -20, r: "Du hast Sektor für Sektor der Festplatte gescannt. Du hast die Datei gefunden! Lena bringt dir morgen Kuchen. Held der Arbeit." },
			{ t: "Trösten & Ausrede erfinden", m: 15, l: 10, a: -10, b: 10, r: "Du sagst ihr, sie soll 'Virus' rufen. Sie kommt ungeschoren davon, aber die IT (du) steht jetzt dumm da." }
		]
	},
	{
		id: "call_junior",
		...
		opts: [
			{ t: "'Die Firewall-Matrix hat negative Polarität.'", next: "path_junior_matrix",rep: { "Dr. Wichtig": -2 }, m: 15, l: 5, a: 0, b: -5, r: "Du brabbelst technisches Kauderwelsch. Er checkt es nicht, murmelt 'Scheiß Technik' und legt auf. Gefahr gebannt." },
			{ t: "Sofort die Ports öffnen", next: "path_junior_ports", rep: { "Dr. Wichtig": 10 }, m: 10, l: 20, a: 0, b: 10, r: "Der Junge ist glücklich. 2 Stunden später ist das Firmennetz voller russischer Bots, weil du alles aufgemacht hast. Das wird ein Nachspiel haben." },
			{ t: "'Hör zu, Kleiner...'", next: "path_junior_eskal", rep: { "Dr. Wichtig": -10 }, m: 5, l: 0, a: -20, b: 30, r: "Du erklärst ihm lautstark, dass er ein verzogenes Balg ist. Er fängt an zu schreien. Der Chef kommt bereits die Treppe runtergestampft." }
		]
	},
	{
		id: "call_skynet",
		...
		opts: [
			{ t: "AGBs lesen und akzeptieren", m: 120, l: -40, a: 30, b: -10, r: "Du hast 2 Stunden lang Kleingedrucktes gelesen. Alle hassen dich, weil sie so lange eingesperrt waren." },
			{ t: "Stecker ziehen", m: 5, l: 10, a: 0, b: 20, r: "Alles ist aus. Auch das Licht. Aber die Türen sind offen." },
			{ t: "Mit Hammer 'verhandeln'", req: "hammer", m: 20, l: -10, a: -30, b: 10, r: "Du hast den Zentralserver der KI zertrümmert. Die Türen sind offen. Sachschaden: 10.000€. Befriedigung: Unbezahlbar." }
		]
	},
	{
		id: "call_phish",
		...
		opts: [
			{ t: "Sich dumm stellen & Zeit schinden", next: "path_phish_troll", m: 45, l: 20, a: -20, b: 5, r: "Du tust so, als wärst du der dümmste User der Welt. 'Ist die Any-Key Taste vorne oder hinten?' Nach 45 Minuten legt sie wütend auf. Ein Fest!" },
			{ t: "Trillerpfeife ins Mikrofon blasen", m: 2, l: 0, a: -10, b: 0, r: "Du pfeifst mit 120 Dezibel in den Hörer. Das Trommelfell am anderen Ende dürfte hinüber sein. Kurzer Prozess." },
			{ t: "Ihr gutgläubig die Kreditkarte geben", next: "path_phish_karte", m: 10, l: 10, a: 30, b: 80, r: "Du hast ihr wirklich die Firmenkarte gegeben?! Bist du wahnsinnig? Das Konto ist in Sekunden leergeräumt. Die Kündigung droht!" }
		]
	},
	{
		id: "call_deaf",
		...
		opts: [
			{ t: "Headset lauter drehen", m: 10, l: 0, a: 5, b: 0, r: "Du drehst das Headset auf Maximum und brüllst Diagnoseschritte über den Baustellenlärm. Das halbe Büro hört mit, wie du 'HABEN SIE ES AUSGESCHALTET?' ins Telefon rufst. Das wird morgen jemand nachmachen. Wochenlang." },
			{ t: "NC-Kopfhörer aufsetzen", req: "headphones", m: 15, l: 5, a: -10, b: 0, r: "Dank Noise-Cancelling hörst du sein Geschrei klar, aber gedämpft. Du bleibst Zen-artig ruhig." },
			{ t: "Auflegen", m: 2, l: 5, a: 0, b: 5, r: "Du legst auf und schiebst es auf die Leitung. Bei dem Lärm merkt er es nicht einmal, sondern schreit noch eine Weile in ein totes Telefon. Irgendwann ruft er wieder an, aber nicht heute." }
		]
	},
	{
		id: "call_cd_stuck",
	...
	},
	{
		...
		opts: [
			{ t: "Mit ihm gemeinsam raten", rep: { "Dr. Wichtig": -5 }, m: 20, l: 0, a: 20, b: 10, r: "Du fragst: 'War es vielleicht Ihr Geburtstag?' Nein. 'Name der Geliebten?' Langes Schweigen. Er wird langsam richtig wütend." },
			{ t: "Passwort mit dem USB-Stick knacken", req: "usb_stick", rep: { "Dr. Wichtig": 10 }, m: 10, l: 5, a: 0, b: 0, r: "Du liest das Passwort in 10 Sekunden aus. Er ist tief beeindruckt von deinen Hacker-Skills (und sollte dir eigentlich aus Angst sofort kündigen)." },
			{ t: "Root-Zugang nutzen & zurücksetzen", req: "admin_pw", rep: { "Dr. Wichtig": 10 }, m: 5, l: 10, a: 0, b: -10, r: "Du setzt es remote auf 'Chef123' zurück. Er atmet auf: 'Gute Arbeit, Müller. Behalten Sie das für sich.'" }
		]
	},
	{
		id: "call_monitor_arm",
		...
		opts: [
			{ t: "Schraube festziehen", req: "screw", m: 5, l: 0, a: -5, b: 0, r: "Eine halbe Umdrehung mit dem richtigen Werkzeug, und der Arm hält wieder. Drei Jahre Meeting-Komik, beendet in fünf Sekunden. Danken wird es dir niemand, aber der Bildschirm schaut wieder geradeaus." },
			{ t: "Stütze bauen", req: "manual", m: 5, l: 5, a: 0, b: 0, r: "Das Windows-95-Handbuch hat exakt die richtige Dicke, als wäre es dafür gedruckt worden. Nach dreißig Jahren im Regal hat es endlich eine Aufgabe. Irgendwo schließt sich ein Kreis." },
			{ t: "Ignorieren", m: 2, l: 10, a: 0, b: 5, r: "Du erklärst die Neigung zum Feature: ergonomischer Blickwinkel. Der Vertrieb präsentiert ab sofort leicht gebückt. Die Kollegen werden sich daran gewöhnen, und genau darauf setzt du." }
		]
	},
	{
		...
		opts: [
			{ t: "Techniker rufen", m: 30, l: 10, a: 0, b: 5, r: "Der Techniker nennt einen Termin in 3 Tagen, Zeitfenster 8 bis 17 Uhr. Bis dahin rattert der Kopierer weiter durch den Boden, und die Buchhaltung arbeitet mit Gehörschutz. Frau Elster trägt ihren mit einer Würde, als hätte sie ihn schon immer besessen." },
			{ t: "Perkussive Wartung", req: "hammer", m: 5, l: 5, a: -20, b: 10, r: "Ein gezielter Schlag an die Seite. Das Rattern hört auf. Stille. User klatschen." },
			{ t: "Dämpfer basteln", req: "tape", m: 20, l: -5, a: 5, b: 0, r: "Du klebst aus Panzertape und Filzresten eine Dämpfung unter die Gerätefüße. Das Rattern wird zum Brummen, das Brummen zur Gewohnheit. Keine schöne Lösung, aber eine, die bis zum Techniker hält." }
		]
	},
	{
		id: "call_cnc",
		...
		opts: [
			{ t: "Floppy-Emulator vom Stick booten", req: "usb_stick", m: 45, l: -20, a: 10, b: -20, next: "path_cnc_emulator", r: "Du hackst den Parallelport und mountest ein Image. Für einen Nachmittag bist du der gefährlichste Mensch im ganzen Maschinenpark. Die Produktion läuft wieder an." },
			{ t: "Im verstaubten Handbuch nachsehen", req: "manual", m: 30, l: -10, a: 0, b: 0, r: "Du blätterst das fettige Buch durch. Tatsächlich! Ganz hinten klebt die Diskette im Umschlag. Glück muss man haben." },
			{ t: "Einfach mal neu starten", m: 15, l: 0, a: 10, b: 20, r: "Schlechte Idee. Der Puffer-Speicher war leer. Die Fräse spinnt und bohrt sich mit einem lauten Kreischen in den eigenen Tisch. Totalschaden." }
		]
	},
	{
		id: "call_cable_chaos",
		...
		opts: [
			{ t: "Tape an Tisch", req: "tape", m: 10, l: 0, a: 0, b: 0, r: "Vier Streifen Panzertape quer über die Tischkante, fertig. Es sieht aus wie ein Verband nach einem Arbeitsunfall, aber der Stecker bleibt drin. Bis jemand den Tisch verschiebt." },
			{ t: "Ihn belehren", m: 15, l: 0, a: 10, b: 0, r: "Du erklärst geduldig Zugentlastung, Kabelkanäle und warum ein Stecker kein Stolperseil ist. Er nickt durchgehend und tritt noch während deiner Erklärung das Netzkabel aus der Buchse." },
			{ t: "Kabelbinder-Einsatz", req: "zip_ties", m: 20, l: -5, a: -10, b: 0, r: "Alles sauber gebündelt und hochgebunden. r/CablePorn Material." }
		]
	},
	{
		...
		opts: [
			...
			{ 
				t: "Verwirrung stiften: Aus dem Windows-95-Handbuch vorlesen", 
				req: "manual", 
				m: 10, l: 5, a: -10, b: 0, 
	...
	},
    {
        ...
        results: {
            res_weird: { txt: "Du legst auf und starrst den Hörer noch eine Weile an. Keine Nummer, kein Wort, nur Atmen. Du entscheidest dich, an ein defektes Faxgerät zu glauben. Mit dieser Version lässt sich weiterarbeiten.", m: 3, l: 0, a: 10, b: 0 },
            hello: { txt: "Auf dein 'Hallo?!' folgt ein Klicken, dann das Freizeichen. Wer immer das war, wollte nur hören, wer abnimmt. Du sagst dir, dass das nichts zu bedeuten hat.", m: 2, l: 0, a: 0, b: 0 }
        }
    },
	{
    ...
    },
    {
        ...
        results: {
            truth: { txt: "Du gestehst den Azubi. Die Leitstelle diktiert dir die Fehlalarm-Gebühr mit der Routine von jemandem, der diesen Satz täglich sagt: 500 Euro, Rechnung folgt. Die halbe Stunde Belehrung gibt es kostenlos dazu.", rep: { "Kevin": -5 }, m: 30, l: 0, a: -5, b: 10 },
            lie: { txt: "Du sagst 'Es brennt', und die Feuerwehr nimmt dich beim Wort: 3 Löschzüge, Vollsperrung, 200 Kollegen auf dem Parkplatz. Als klar wird, dass nichts brennt, sucht der Einsatzleiter das Gespräch mit dir. Es ist kein gutes Gespräch.", rep: { "Kevin": 5 }, m: 60, l: -10, a: 50, b: 50 }
        }
    },
    {
        ...
        results: {
            res_rescue: { txt: "Kevin ist unversehrt und um eine Anekdote reicher. Die Rechnung landet trotzdem auf deinem Tisch.", rep: { "Kevin": 10 }, m: 35, l: -5, a: 25, b: 30 },
            res_refund: { txt: "Die Anlage wird neu befüllt. 8.400 Euro, die in keinem Budget stehen. Frau Elster wird das finden.", rep: { "Frau Elster": -10 }, m: 25, l: 0, a: 20, b: 35 },
            res_cover: { txt: "Offiziell war es ein Test. Der Bericht ist unterwegs zur Geschäftsführung, und darin steht das Wort 'Fehlauslösung'.", rep: { "Kevin": 5, "Dr. Wichtig": -10 }, m: 20, l: 10, a: 15, b: 55 }
        }
    },
	{
		id: "call_gabi_sugar",
	...
	},
    {
        ...
        results: {
            res_fun: { txt: "Zwanzig Minuten lang hast du versucht, eine Fernwartung auf einer Mikrowelle zu installieren. Am Ende schreit er, du seist der dümmste Mensch der Welt, und legt auf. Selten hat dich eine Beleidigung so glücklich gemacht.", m: 20, l: 10, a: -10, b: 0 },
            rage: { txt: "Du brüllst drei Stockwerke Frust in den Hörer. Der Scammer legt gelangweilt auf - für ihn bist du Anruf 400 heute. Deine Kollegen hingegen rücken ihre Kopfhörer zurecht und tun sehr beschäftigt.", m: 5, l: 0, a: 5, b: 5 }
        }
    },
        {
    ...
    },
    {
        ...
        results: {
            res_money: { txt: "Er schickt dir ein Angebot. Du nutzt es für die nächste Gehaltsverhandlung.", m: 15, l: 5, a: -5, b: 5 },
            res_hacker: { 
            ...
            res_printer: { txt: "Die Leitung ist tot, bevor du den Satz beendet hast. Das Silicon Valley sucht Visionäre, keine Leute, die wissen, wo im Kopierer der Papierstau sitzt. Ihre Server möchte man trotzdem nicht sehen.", m: 5, l: -5, a: 5, b: 0 },
            res_nothing: { txt: "'Okay, bye' war das ganze Abschiedsgespräch. Du bleibst, wo du bist: unterbezahlt, aber du weißt hier wenigstens, wo die Kaffeemaschine steht. Loyalität hat ihren Preis, und du zahlst ihn monatlich.", rep: { "Dr. Wichtig": 2 }, m: 5, l: 0, a: -5, b: -5 }
        }
    },
    {
        id: "call_fbi_1",
        ...
        results: {
            joke: { txt: "'Humor. Verstehe. Das sagen alle.' Die Leitung knackt zweimal, dann ist das Gespräch beendet. Ab mittags lädt jede Webseite spürbar langsamer. Das kann Zufall sein. Es fühlt sich nicht wie Zufall an.", m: 20, l: -10, a: 20, b: 0 },
            paranoid: { txt: "Die SIM-Karte schmeckt nach Elektronik und schlechten Entscheidungen. Beweise gibt es keine mehr, dafür ein Knirschen beim Kauen und die Erkenntnis, dass Panik kein guter Berater ist. Das Festnetz funktioniert übrigens noch.", m: 5, l: -20, a: 50, b: 0 }
        }
    },
    {
        id: "call_pizza_wrong",
        ...
        results: {
            res_honest: { txt: "Der Lieferant flucht und geht wieder. Dein Magen knurrt.", m: 2, l: 0, a: 5, b: 0 },
            res_food_coma: { 
    ...
    },
    {
        ...
        results: {
            "res_nato_teach": { txt: "Du erklärst ihr 10 Minuten lang 'Alpha, Bravo, Charlie'. Sie nennt dich am Ende einen 'Klugscheißer'. Aber das Passwort stimmt.", m: 15, l: -5, a: 15, b: -5 },
            "res_nato_suffer": { txt: "Nach ungelogen 20 Minuten hast du das 8-stellige Passwort zusammen. Deine Aggression ist durch die Decke, dein Wille gebrochen.", m: 20, l: -5, a: 30, b: -10 },
            "res_nato_reset": { txt: "Du setzt es genervt per Master-Override auf 'Willkommen123!' zurück. Keine Zeit für diesen Buchstabiersalat.", m: 5, l: 10, a: 5, b: -5 },
            "res_nato_hangup": { txt: "Du legst auf, ohne ein weiteres Wort. Du kannst das heute nicht. Das Ticket bleibt offen und wird später garantiert eskalieren.", m: 2, l: 10, a: 0, b: 15 }
        }
    },
    {
        id: "call_any_key_1",
    ...
    },
    {
        ...
        results: {
            "res_remote_fix": { txt: "Du klickst die 50 offenen Browser-Fenster per Fernwartung zu. PC läuft wieder. Du hast dir eine furchtbar dumme Konversation erspart und das Ticket professionell geschlossen.", m: 5, l: -5, a: 5, b: -5 },
            "res_facepalm": { txt: "Du musst ihr mühsam den Unterschied zwischen Glasfenstern und digitalen Fenstern erklären. Deine Gehirnzellen sterben ab, aber der Support war vorbildlich.", m: 15, l: 0, a: 20, b: -5 },
            "res_troll_window": { txt: "Frau Schulze schwitzt jetzt in ihrem Büro. Der PC ist zwar immer noch langsam, aber sie beschwert sich nicht mehr. Unprofessionell, aber du hast Ruhe.", m: 5, l: 10, a: -5, b: 5 }
        }
    },
    {
    ...
    },
    {
        ...
        results: {
            "res_safe": { txt: "Du kommst ohne Kosten davon, aber HR hasst dich jetzt noch ein bisschen mehr.", m: 10, l: 0, a: 5, b: 10 },
            "res_fail": { txt: "Das war eine extrem dumme Ausrede, und ihr wisst es beide. Der Chef sagt nichts weiter. Er merkt es sich nur - und zwar an prominenter Stelle.", m: 5, l: 0, a: 10, b: 25 }
        }
    },
    {
        id: "call_dance_2c",
        ...
        results: {
            "res_hangup": { txt: "Zehn Minuten später liegt die Rechnung über 8.000 Euro beim Chef, Vermerk: 'Verursacher unbekannt'. Der Suchradius ist klein. Du arbeitest ab sofort sehr sichtbar und sehr unauffällig zugleich.", m: 2, l: 0, a: -5, b: 20 },
            "res_lie": { txt: "'5G' war offenbar das falsche Wort. Er legt mit einer Lautstärke auf, die man durch den Hörer hindurch spürt. Immerhin kennt er deinen Namen nicht. Das kann sich ändern.", m: 5, l: 0, a: 5, b: 15 }
        }
    },
    {
        id: "call_awkward_2c",
        ...
        results: {
            "res_hr_seminar": { txt: "Vier Stunden Seminar stehen dir bevor, mit Anwesenheitsliste. Dein Name steht schon drauf, handschriftlich ergänzt.", m: 15, l: 0, a: 10, b: 20 },
            "res_hr_boss": { txt: "Der Chef wird das nicht lustig finden. Die Gerüchte werden zur Aktennotiz.", m: 5, l: 0, a: 10, b: 30 }
        }
    },
    {
...
},
{
	...
	},
	{
		...
		results: {
			res_handy: { txt: "Er verlässt das Meeting am Handy, das Echo ist weg, und er erklärt der Runde, du hättest 'am Server was umgestellt'. Widersprechen bringt an dieser Stelle nichts mehr.", m: 10, l: -5, a: 5, b: -5 },
			res_zuhoeren: { txt: "Du bleibst stumm. Er redet elf Minuten mit seinem eigenen Echo und kommt zu dem Schluss, dass die Leitung überlastet ist. Du hast in der Zeit nichts getan und dich sehr dabei entspannt.", m: 15, l: 15, a: -10, b: 5 },
			res_bestellung: { txt: "Du legst ein Ticket an, das im Einkauf landet, also bei ihm. Er wird es in zwei Wochen ablehnen, weil kein Budget da ist, und dich anrufen, um sich darüber zu beschweren.", m: 10, l: 0, a: 5, b: 0 },
			res_einkauf: { txt: "'Ich soll mir das selbst bestellen?' Er sagt es, als hättest du ihn gebeten, den Kopierer zu reparieren. Aber er tut es, und es kommt sogar an.", m: 5, l: 0, a: 10, b: 5 },
			res_ruhig: { txt: "Er löst sein Problem selbst, während du schweigst. Er bedankt sich überschwänglich für deine Hilfe. Du hast keine geleistet, und das ist heute das beste Ergebnis.", m: 5, l: 0, a: -10, b: -5 }
		}
	},
	{
