export const bossfights = [

   {
		...
		timer: 10, 
		opts: [
			{ t: "Admin-Code eingeben", req: "admin_pw", m: 5, l: 0, a: -10, b: -20, r: "Du tippst den Admin-Code, der Countdown bleibt stehen, und der Totenkopf verschwindet Zeile für Zeile. Niemand hat es gesehen. Du sitzt danach zwei Minuten still da, und niemand wird je erfahren, wie knapp das war." },
			{ t: "Stecker ziehen!", m: 10, l: -10, a: 20, b: 10, r: "Du ziehst den Stecker mitten im Verschlüsselungslauf. Der Server ist aus, der Angriff auch. Ob die Daten den Abbruch überstanden haben, weiß frühestens morgen jemand, und niemand spricht es heute aus." }
		],
		fail: {rep: { "Dr. Wichtig": -20 }, m: 30, l: 0, a: 50, b: 50, r: "Der Zähler läuft ab, während du noch überlegst. Danach sind alle Dateien verschlüsselt, auch die Sicherung, weil sie am selben Netz hing. Der Chef schreit sich in eine Lautstärke, die man zwei Etagen tiefer hört." }
	},
	{
		id: "boss_fire",
		...
		timer: 8,
		opts: [
			{ t: "Wegrennen und Alarm drücken", m: 60, l: 10, a: 10, b: 25, r: "Die Feuerwehr braucht sieben Minuten und ist mit vier Leuten da. Das Haus steht auf dem Parkplatz, die halbe Belegschaft in Hausschuhen, und du stehst dazwischen mit dem Gefühl, alles richtig gemacht zu haben." },
			{ t: "Feuerlöscher benutzen", req: "fire_ext", m: 30, l: -10, a: 10, b: -20, r: "Zwei Stöße mit dem Löscher, dann ist es aus. Du hustest den halben Nachmittag und riechst noch abends danach. Egon kommt später vorbei, sieht sich das Rack an und sagt: 'Sauber gemacht.' Mehr sagt er nicht.",
				next: "path_boss_fire_geloescht" }
		],
		fail: { m: 120, l: -20, a: 30, b: 40, r: "Die Sprinkleranlage löst aus, und zwar überall gleichzeitig. Von der Decke regnet es auf Racks, Aktenordner und einen Karton mit Weihnachtsdeko. Das Feuer ist aus. Alles andere auch." }
	},
	{
		id: "boss_stream",
		char: "Dr. Wichtig",
		...
		timer: 12,
		opts: [
			{ t: "Backup-Leitung mit einem Ersatzkabel schalten", req: "cable", rep: { "Dr. Wichtig": 10 }, m: 5, l: -10, a: 0, b: -20, r: "Profi-Reaktion! Der Stream läuft wieder in 4K. Der CEO wirkt erleichtert (und schwitzt)." },
			{ t: "Qualität auf 'Kartoffel' (240p) setzen", rep: { "Dr. Wichtig": -5 }, m: 5, l: 5, a: 0, b: 25, r: "Es läuft wieder flüssig. Aber der CEO sieht aus wie eine Lego-Figur. Aus dem Stream-Chat regnen Klötzchen-Emojis." }
		],
		fail: { rep: { "Dr. Wichtig": -20 }, m: 20, l: 0, a: 40, b: 60, r: "Der Stream bricht ab, und fünftausend Zuschauer sehen ein schwarzes Bild mit einer Fehlernummer. Der Kurs gibt bis Handelsschluss zehn Prozent nach. Der Chef kommt nicht an, er kommt herunter." }
	},
	{
		id: "boss_ddos",
		...
		timer: 15,
		opts: [
			{ t: "Stecker vom Router ziehen", m: 5, l: 10, a: -5, b: 20, r: "Der Angriff ist gestoppt. Aber wir sind offline. Technisch gesehen ein Erfolg, wirtschaftlich eine Katastrophe." },
			{ t: "Geo-Blocking aktivieren", m: 10, l: -5, a: 5, b: -5, r: "Zack! Der ganze Traffic aus Übersee ist geblockt. Die Seite läuft wieder. Kollateralschaden gering." }
		],
		fail: { m: 60, l: -10, a: 30, b: 40, r: "Der Server geht in die Knie und nimmt die Firmenseite mit. Bis zum Abend ist der Ausfall ein eigenes Schlagwort im Netz, mit Bildschirmfotos, und Chantal beantwortet Kommentare, bis ihr jemand das Handy abnimmt." }
	},
	{
		id: "boss_heat",
		...
		timer: 10,
		opts: [
			{ t: "Fenster einschlagen", req: "hammer", m: 5, l: 0, a: 20, b: 10, r: "Klirr! Eiskalte Luft strömt herein (und ein paar Tauben). Hardware gerettet, Fenster kaputt." },
			{ t: "Not-Aus drücken", m: 5, l: 5, a: 10, b: 25, r: "Alles fährt runter. Die Stille ist gespenstisch. Hardware sicher, aber die Firma steht still." }
		],
		fail: { m: 120, l: -20, a: 50, b: 50, r: "Bei einundfünfzig Grad schalten sich die ersten Server selbst ab, bei dreiundfünfzig riecht es nach verschmortem Kunststoff. Der Rauchmelder geht an, und du bist als Einziger nah genug, um zu wissen, dass es diesmal echt ist." }
	},
	{
		id: "boss_db_purge",
		char: "Kevin",
	...
	},
	{
		...
		timer: 10,
		opts: [
			{ t: "Aus dem Fenster werfen", m: 5, l: 10, a: 20, b: 20, r: "Du hast das 20kg Teil durchs geschlossene Fenster geworfen. Es explodiert auf dem Parkplatz. Besser dort als hier." },
			{ t: "MacGyver-mäßig mit Panzertape abdichten", req: "tape", m: 10, l: 0, a: 0, b: -10, r: "Du wickelst eine ganze Rolle Panzertape drum. Es hält den Druck... gerade so. Zeitbombe entschärft (für heute)." }
		],
		fail: { rep: { "Dr. Wichtig": -20 }, m: 240, l: -30, a: 40, b: 80, r: "Die Batterie gibt nach. Was austritt, frisst sich durch den Doppelboden und tropft eine Etage tiefer auf den Schreibtisch, an dem gerade niemand sitzt. Der Geruch hält sich drei Wochen." }
	},
	{
		id: "boss_skynet_lock",
	...
	},
	{
		...
		timer: 9,
		opts: [
			{ t: "Überdruckventil öffnen", req: "screw", m: 5, l: -5, a: -10, b: -5, r: "Pfeifend entweicht der Druck. Du bist der Held der Belegschaft. Applaus im Flur!" },
			{ t: "Stecker ziehen & wegrennen", m: 5, l: 10, a: 25, b: 10, r: "Die Maschine beruhigt sich langsam. Aber: KEIN KAFFEE MEHR HEUTE. Die Kollegen schauen dich mit mordlustigen Augen an." }
		],
		fail: { m: 60, l: 0, a: 50, b: 20, r: "Der Kessel gibt nach. Danach ist die Küche bis zur Decke mit Kaffeesatz ausgekleidet, die Maschine ist Schrott, und im Haus sinkt binnen einer Stunde alles, was man messen könnte." }
	},
	{
		...
		fail: { r: "Der Drucker überhitzt, und was danach kommt, ist eher ein dumpfer Schlag als eine Explosion. Die Sprinkler springen trotzdem an. Alles ist nass, du bist nass, und der Tag ist gelaufen.", m: 60, l: -10, a: 50, b: 50 }
	},
	{
		id: "boss_cable_mess",
		...
		fail: { rep: { "Dr. Wichtig": -10 }, r: "Der Prüfer öffnet die Tür. Er sieht das Chaos. Er weint leise. 'Zertifikat entzogen.' Der Chef tobt.", m: 60, l: 0, a: 40, b: 60 }
	},
	{
		id: "boss_water_leak",
		...
		fail: { rep: { "Dr. Wichtig": -10 }, r: "ZAPP! Kurzschluss. Funkenflug. Dunkelheit. Der Server ist tot. Der Kühlschrank ist tot. Der Chef steht im Dunkeln und brüllt deinen Namen.", m: 60, l: 0, a: 50, b: 50 }
	},
	{
		id: "boss_vga_fail",
		...
		fail: { rep: { "Dr. Wichtig": -10 }, r: "Bild weg. Chef: 'Äh... Technik...' Im Saal beginnt höfliches, tödliches Kichern. Der Aktienkurs fällt um 2%. Der Chef macht dich persönlich haftbar.", m: 60, l: 0, a: 40, b: 80 }
	},
	{
		id: "boss_audit",
		...
		opts: [
			{ 
				...
				req: "manual", 
				m: 5, l: 10, a: -10, b: -10, 
				r: "Du wirfst ihm das Windows-95-Handbuch hin. Er blättert... nickt... 'Sehr klassisch. Genehmigt.' Puh. Kompetenz durch Alter." 
			},
			{ 
		...
		fail: { r: "Der Prüfer schreibt vierzig Minuten. Das Bußgeld steht am Ende unter einer Zeile, die mit 'wiederholt festgestellt' beginnt. Der Chef liest sie dreimal und sucht dabei jemanden, den er ansehen kann.", m: 120, l: -50, a: 50, b: 100 }
	},
	{
		id: "boss_flood",
		...
		opts: [
		 ...
		 fail: { r: "Das Wasser läuft aus. Irgendwo knallt es elektrisch. Büro zerstört. Kois tot. Du wirst wohl gefeuert.", m: 60, l: 0, a: 50, b: 100 }
	},
	{
	id: "boss_demo_fail",
	...
	fail: { m: 60, l: 0, a: 50, b: 80, r: "Du klickst daneben, und zwar auf 'Neues Spiel'. Die Karten legen sich vor fünftausend Zuschauern neu aus. Die Investoren lachen, und einer applaudiert." }
	},
    {
        ...
        fail: { rep: { "Dr. Wichtig": -30 }, m: 180, l: 0, a: 40, b: 50, r: "Du bewegst dich nicht, während der Zähler abläuft. Danach ist die gesamte Firmen-Cloud unlesbar. Der Chef holt tief Luft, sagt drei Sätze und dann einen vierten, den er zurücknimmt." }
    },
    {
        ...
        fail: { rep: { "Dr. Wichtig": -40 }, m: 30, l: 0, a: 30, b: 40, r: "Jemand hat mitgeschnitten. Bis zum Abend läuft der Ausschnitt in einem Netzwerk, in dem der Chef sein Profil pflegt, und darunter diskutieren Leute, die ihn kennen." }
    },
    {
...
{ t: "Die Verbindungen auf den Ersatz-Switch umstecken", req: "cable",
  ...
  r: "Du ziehst Port für Port um, mit dem Ersatzkabel aus dem Rucksack, und lässt den nassen Switch allein zurück. Als das Wasser ihn erreicht, hängt nichts mehr daran. Egon findet ihn zwei Tage später und nickt anerkennend." }
        ...
        fail: { m: 90, l: -10, a: 30, b: 40, r: "Das Wasser erreicht den Core-Switch. Es macht kein dramatisches Geräusch, nur ein kurzes Knistern, und danach ist das ganze Gebäude ohne Netz." }
    },
    {
        id: "boss_rogue_ai_1",
        ...
        fail: { rep: { "Dr. Wichtig": -20 }, m: 120, l: 0, a: 25, b: 30, r: "Vierhundert Kündigungsschreiben sind zugestellt, alle mit korrekter Anrede. Die Personalabteilung ist telefonisch nicht mehr erreichbar, und im Flur steht eine Schlange bis zum Aufzug." }
    },
    {
        ...
        opts: [
            { 
                t: "Das dicke Windows-95-Handbuch auf den Tisch knallen",
                req: "manual", 
                m: 15, l: 0, a: -5, b: -15, 
        ...
        fail: { rep: { "Dr. Wichtig": -15 }, m: 45, l: 10, a: 25, b: 45, r: "Du findest keinen Satz. Der Prüfer wartet höflich, notiert dann etwas und wertet das Schweigen als das, was es ist. Die Abmahnung trifft nicht dich allein, sondern das ganze Team." }
    },
    {
        id: "boss_lockdown_1",
        ...
        fail: { m: 180, l: 20, a: 40, b: 15, r: "Irgendwer ruft die Feuerwehr. Die kommt mit drei Fahrzeugen und öffnet das Haupttor auf die einzige Art, die dann noch geht. Die Rechnung dafür sieht man Wochen später im Verteiler." }
    },
    {
        ...
        fail: { m: 120, l: -10, a: 40, b: 60, r: "Die Notabschaltung greift und nimmt alles vom Netz, gleichzeitig und ohne Rückfrage. Die Firma ist für heute offline. Es dauert bis zum Abend, bis der Raum kühl genug zum Betreten ist." }
    },
    {
        id: "boss_ddos_1",
        ...
        fail: { rep: { "Dr. Wichtig": -15 }, m: 60, l: 0, a: 40, b: 30, r: "Der Core-Router steigt unter der Last aus. Das Neustarten dauert siebzehn Minuten, in denen niemand etwas tun kann außer zusehen. Die Kunden schreiben in dieser Zeit sehr viele Mails." }
    },
    {
        id: "boss_excavator_1",
        ...
        fail: { m: 240, l: 20, a: 20, b: 30, r: "Ohne Netz kehrt das Haus in einen früheren Zustand zurück: Zettel auf den Fluren, Leute, die einander suchen, und erstaunlich viele Gespräche. Gearbeitet wird nichts." }
    },
    {
        ...
        fail: { rep: { "Frau Elster": -30, "Dr. Wichtig": -20 }, m: 60, l: 0, a: 30, b: 30, r: "Du zögerst zu lange, und die Datenbank gibt ganz auf. Morgen ist Jahresabschluss, und die Prüfer werden Fragen stellen, auf die es keine Antworten gibt, nur Erklärungen." }
    },
    {
        ...
        fail: { m: 240, l: 0, a: 40, b: 50, r: "Die Beamten gehen an dir vorbei, ziehen die Kabel selbst und nehmen mit, was sie für relevant halten. Sie sind gründlich, höflich und in vierzig Minuten fertig." }
    },
    {
        ...
        opts: [
            { 
                ...
                rep: { "Dr. Wichtig": -20 },
                m: 10, l: -10, a: 15, b: 5, 
                r: "'STECKER ZIEHEN, SIE IDIOT!', brüllst du. Er macht es tatsächlich. Die Daten bleiben erhalten, dein Job wackelt."
            },
            { 
        ...
        fail: { rep: { "Dr. Wichtig": -10 }, m: 60, l: 0, a: 30, b: 40, r: "Das Laufwerk ist leer, und die Sicherungen tragen dasselbe Skript in sich. Ihr fangt bei null an, mit einem Ordner, den jemand privat auf einem Stick hatte." }
    },
    {
        ...
        fail: { m: 180, l: 30, a: 45, b: 15, r: "Am Nachmittag redet niemand mehr. Zwei Leute gehen früher, drei tun so, als arbeiteten sie, und du sitzt vor einem Bildschirm und liest denselben Satz viermal." }
    },
	   ...
	   ------------------------------------------------------------------- */
	{
		...
		opts: [
			...
			{ t: "Den Shop offline nehmen, bis es geklärt ist", m: 20, l: 0, a: 15, b: 20,
			...
			{ t: "Die Warnung wegklicken lassen und Anleitung verschicken", m: 10, l: 5, a: 20, b: 10,
	...
	},
	{
		...
		opts: [
			...
			{ t: "In den Besprechungsraum laufen und das Kabel ziehen", m: 15, l: -10, a: 5, b: 0,
			...
			{ t: "Den ganzen Switch neu starten", m: 10, l: 0, a: 20, b: 15,
	...
	},
	{
		...
		opts: [
			{ t: "Die vier Geräte kontrolliert herunterfahren", m: 30, l: -10, a: 10, b: -10,
			...
			{ t: "Die Meldung an den Chef weitergeben und abwarten", m: 5, l: 10, a: 15, b: 20,
	...
	},
	{
		...
		opts: [
			...
			{ t: "Egon den Notaus drücken lassen", m: 10, l: 5, a: 10, b: 5,
			...
			{ t: "Die zweiundvierzig Minuten abwarten und dokumentieren", m: 45, l: -5, a: 5, b: -5,
...

	{
		...
		opts: [
			...
			{ t: "Die Anlage komplett abschalten", m: 5, l: 0, a: 15, b: 20,
			...
			{ t: "Egon holen und die Anlage von Hand drosseln", m: 25, l: -5, a: 0, b: 5,
			  rep: { "Egon": 5 },
	...
	},
	{
		...
		opts: [
			...
			{ t: "Alles in den Serverraum schieben", m: 15, l: -5, a: 10, b: 0,
			...
			{ t: "Die Begehung an der Etage vorbeilotsen", m: 25, l: 0, a: 15, b: 15,
			...
			{ t: "Den Absender ausfindig machen und abholen lassen", m: 30, l: -10, a: 5, b: -5,
...

	{
		...
		opts: [
			...
			{ t: "Das Netzwerkkabel des Verteilservers ziehen", m: 5, l: -5, a: 10, b: 5,
			  next: "path_boss_update_gestoppt",
			...
			{ t: "Es durchlaufen lassen und danach erneut zurückrollen", m: 40, l: -10, a: 20, b: 10,
	...
	},
	{
		...
		opts: [
			...
			{ t: "Nach etwas fragen, das nur ein Kollege wissen kann", m: 10, l: 0, a: 5, b: -5,
			  next: "path_boss_anruf_geprueft",
			...
			{ t: "Den Zugriff geben, sie klingt echt", m: 5, l: 5, a: 25, b: 30,
			...
			{ t: "Auflegen, ohne etwas zu sagen", m: 5, l: 0, a: 10, b: 5,
