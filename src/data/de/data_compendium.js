...
export const compendium = [
    ...
    /* ---------------------------------------------------------------- PERSONEN */
    {
        ...
        summary: "Zuständig für alles, was das Gebäude selbst anstellt. Erreichbar, wenn man ihn wie einen Menschen behandelt und nicht wie ein Ticketsystem.",
    ...
    },
    {
        ...
        name: "Frau R. Sonntag",
        role: "Buchhaltung",
        summary: "Führt Listen, führt sie richtig, und hält jeden Vorgang für heilbar, sobald er eine Nummer hat.",
    ...
    },
    {
        ...
        cat: "person",
        name: "Herr Brandt",
        role: "Vertrieb, extern",
        summary: "Verkauft eine Digitalisierungslösung. Was sie tut, hat in drei Gesprächen niemand herausgefunden, ihn eingeschlossen.",
...

    {
        ...
        role: "Marketing",
        summary: "Traut sich zu fragen, und zwar bevor es zu spät ist. Das unterscheidet sie vom Rest des Hauses.",
    ...
    },
    {
        ...
        cat: "person",
        name: "Bernd",
        role: "Vertrieb, bis zu seinem letzten Tag",
        summary: "Der Kollege, an dem sich zeigt, wie weit dieses Haus jemanden fallen lässt, bevor es nachfragt. Am Ende war es nicht weit genug.",
    ...
    },
    {
        ...
        name: "Lisa",
        role: "Marketing",
        summary: "Fünfzehn Meter Luftlinie und ein Match auf dem Handy. Sie ist charmant, direkt und hat einen Laptop, der komische Geräusche macht.",
    ...
    },
    {
        ...
        summary: "Steht an der Kaffeemaschine, lächelt und fragt, ob der Server brennt. Beides gleichzeitig zu beantworten ist schwerer, als es aussieht.",
    ...
    },
    {
        ...
        cat: "person",
        name: "Jürgen",
        role: "Vertrieb, drittes Obergeschoss",
        summary: "Sucht Gesellschaft und findet sie zuverlässig bei dir. Er meint es gut, und genau das macht es so schwer.",
    ...
    },
    {
        ...
        name: "Sabine",
        role: "Personalabteilung",
        summary: "Schafft eine inklusive Atmosphäre und führt Listen darüber, wer sich daran hält. Beides mit derselben Ernsthaftigkeit.",
    ...
    },
    {
        ...
        name: "Werner",
        role: "Schwiegervater",
        summary: "Ruft auf dem Diensttelefon an, spricht sehr laut und hält die IT für einen Familienbetrieb. In gewisser Weise hat er recht.",
    ...
    },
    {
        ...
        summary: "Nimmt jede Sache ernst und alle gleich ernst. Deshalb dauert bei ihm alles länger und ist am Ende doch dokumentiert.",
    ...
    },
    {
        ...
        name: "Frau Meyer",
        role: "Buchhaltung",
        summary: "Zwischen ihr und der Katastrophe liegen immer genau zehn Minuten. So lange, sagt sie, sei es noch bis zum Termin.",
    ...
    },
    {
        ...
        name: "Herr Aluhut",
        role: "Einkauf",
        summary: "Heißt anders. Meldet sich am Telefon je nach Lage als Eule oder gar nicht, und flüstert grundsätzlich.",
        ...
        notes: [
            ...
            { seen: "call_aluhut_2",     text: "Ruft unter einem Decknamen an. Die Nummer bleibt dieselbe." },
    ...
    },
    {
        ...
        name: "Herr Kunz",
        role: "Lager",
        summary: "Arbeitet, während andere Rücksprache halten. Ruft nur an, wenn wirklich etwas steht.",
    ...
    },
    {
        ...
        summary: "Meldet Symptome zuverlässig und die Ursache vier Minuten später. Man muss ihr nur so lange zuhören.",
    ...
    },
    {
        ...
        name: "Frau Özdemir",
        role: "Projektbüro",
        summary: "Löst Probleme entschlossen und auf dem kürzesten Weg. Leider führt der kürzeste Weg oft an der Sicherheit vorbei.",
    ...
    },
    {
        ...
        name: "Frau Jablonski",
        role: "Einkauf",
        summary: "Vergisst Passwörter zuverlässig und buchstabiert sie noch zuverlässiger falsch. Beides gehört zusammen.",
    ...
    },
    {
        ...
        summary: "Beschreibt Geräte nach dem, wozu sie sie benutzt. Erstaunlich oft hilft das mehr als der Fachbegriff.",
    ...
    },
    {
        ...
        cat: "person",
        name: "Herr Grabowski",
        role: "Ehemaliger Kollege, seit sieben Jahren in Rente",
        summary: "Ruft einmal im Jahr an, immer freundlich, immer wegen derselben Sache. Er hat mehr Geduld als drei IT-Generationen zusammen.",
    ...
    },
    {
        ...
        cat: "person",
        name: "Herr Leuchter",
        role: "Niederlassung Süd",
        summary: "Existiert, das ist gesichert. Erreichbar ist etwas anderes.",
    ...
    },
    {
        ...
        cat: "person",
        name: "Herr Kowalski",
        role: "Automatenvertrieb, extern",
        summary: "Stellt Geräte auf, die besser sind als alles im Haus, und wartet ab. Verkaufen muss er nichts, das erledigt der Vergleich.",
    ...
    },
    {
        ...
        summary: "Spricht fließend Strategie und kein Wort Technik. Beides mit derselben Überzeugung.",
    ...
    {
        id: "k_egon", cat: "team", name: "Egon", role: "Hausmeister",
        summary: "Der eigentliche Hausherr. Besitzt jeden Schlüssel, misstraut jedem Kabel und hat für alles eine Lösung von 1987.",
    ...
    {
        id: "k_wichtig", cat: "team", name: "Dr. Wichtig", role: "Geschäftsführung",
        summary: "Hat Visionen, Termine und ein Telefon im Tunnel. Von allem dreien ist der Tunnel am verlässlichsten.",
    ...
    {
        id: "k_elster", cat: "team", name: "Frau Elster", role: "Buchhaltung",
        summary: "Formvollendet, unbestechlich und unerbittlich. Wer ihre Regeln benutzt statt sie zu umgehen, hat sie auf seiner Seite.",
    ...
    {
        id: "k_markus", cat: "team", name: "Markus", role: "Vertriebsleitung",
        summary: "Verkauft mit echter Begeisterung Dinge, die es noch nicht gibt. Der Rückweg ist regelmäßig dein Problem.",
    ...
    {
        id: "k_gabi", cat: "team", name: "Gabi", role: "Empfang",
        summary: "Die Nachrichtenzentrale. Weiß Dinge vor dem Intranet, und die wichtigen erfährt sie überhaupt nur mündlich.",
    ...
    },
    {
        ...
        notes: [
            ...
            { seen: "cof_sugar_1",         text: "Im Vorratsschrank nebenan wird gehortet, sobald das Wort Rationierung fällt. Bernd aus dem Vertrieb ist immer schon da." },
