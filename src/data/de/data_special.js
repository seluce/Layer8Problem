export const special = {
	...
	week_idle: {
		coffee: {
			...
			opts: [
				{ t: "Leer ausgehen", m: 20, l: 5, a: 0, b: 0, r: "Du starrst in die leere Kanne. Morgen wieder." }
			]
		},
		server: {
			...
			opts: [
				{ t: "Misstrauisch lauschen", m: 20, l: 5, a: 0, b: 0, r: "Nichts. Unheimlich. Du gehst rückwärts wieder raus." }
			]
		},
		calls: {
			...
			opts: [
				{ t: "Auf Anrufe warten", m: 20, l: 5, a: 0, b: 0, r: "Das Telefon bleibt stumm. Du legst den Hörer verkehrt herum auf. Falls doch wer anruft." }
			]
		},
		sidequests: {
			...
			opts: [
				{ t: "Ziellos herumstehen", m: 20, l: 5, a: 0, b: 0, r: "Du drehst eine Runde und landest wieder am Schreibtisch." }
			]
		}
	},
	...
	empty_pool: {
		...
		opts: [
			{ t: "Däumchen drehen", m: 20, l: 5, a: -5, b: 0, r: "Zeit vergeht langsam." }
		]
	}
