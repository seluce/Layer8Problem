...
export const lunch = [
		...
		},
		{
			...
			opts: [
				{ t: "Aussteigen & Brot essen", m: 30, l: 10, a: -10, b: 0, r: "Du isst dein trockenes Brot, während die anderen noch streiten. Friedlich, aber traurig." },
				{ t: "'SALAMI FÜR ALLE!'", m: 45, l: -5, a: 10, b: 0, r: "Du hast bestellt. Die Veganer hassen dich, aber du bist satt. Das Dauergemecker im Hintergrund nagt trotzdem an den Nerven." }
			]
		},
		{
			id: "lunch_business",
			...
			opts: [
				{ t: "Gratis Essen abgreifen", next: "path_lunch_sushi", m: 90, l: 20, a: -10, b: -5, r: "Das Sushi war göttlich. Du hast ihm versprochen, 'mal drüber nachzudenken' (Lüge). Pause überzogen." },
				{ t: "Dankend ablehnen", m: 30, l: -5, a: 0, b: 5, r: "Du bleibst im Büro. Deine Integrität ist gewahrt, aber dein Magen knurrt." }
			]
		},
		{
			id: "lunch_doener",
		...
		},
		{
			...
			opts: [
				{ t: "Power-Nap im Serverraum", m: 45, l: 25, a: -20, b: 10, r: "Du bist eingeschlafen! Du wachst mit Tastatur-Abdruck im Gesicht auf. Hoffentlich hat dich keiner gesehen." },
				{ t: "Doppelter Espresso", m: 10, l: -5, a: 5, b: 0, r: "Das Herzrasen setzt ein. Du bist wach, aber deine Hände zittern. Produktivität: Fragwürdig." }
			]
		},
		{
			id: "lunch_foodtruck",
		...
		},
		{
			...
			opts: [
				{ t: "Nicht mitspielen", m: 10, l: 0, a: 5, b: 0, r: "Du bleibst beim mitgebrachten trockenen Brot. Kein Risiko, kein Ruhm, kein Schimmel." },
				{ t: "Dose 1 öffnen", m: 30, l: 0, a: -10, b: 0, r: "Jackpot! Lasagne! Der Tag ist gerettet." },
				{ t: "Dose 3 öffnen", m: 45, l: -20, a: 30, b: 0, r: "Es war der Schimmel. Du verbringst die Pause würgend auf dem Klo. Gespart: 3 Euro. Verloren: der Nachmittag." }
			]
		},
		{
		...
		},
		{
			...
			opts: [
				{ t: "Sabotieren", m: 10, l: 5, a: -5, b: 10, r: "Du drehst die Heizung auf 30 Grad. Das Training wird abgebrochen. Danke, Held." },
				{ t: "Teilnehmen", rep: { "Dr. Wichtig": 2 }, m: 45, l: -10, a: 10, b: -5, r: "Du hast Liegestütze im Anzug gemacht. Jetzt riechst du nach Iltis. Aber der Chef hat's gesehen." },
				{ t: "Zuschauen & Donut essen", rem: "donut", m: 30, l: 10, a: -10, b: 5, r: "Du isst einen Donut, während die Kollegen leiden. HR guckt böse." }
			]
		},
		{
		...
		{ 
			...
			opts: [ 
				...
				{  
					t: "Windows-95-Handbuch aufschlagen und lesen",
					req: "manual", 
					m: 45, l: -10, a: 0, b: -5,  
   ...
   ------------------------------------------------------------------------- */
{
    ...
    opts: [
        { t: "Wieder mitlaufen", m: 45, l: -10, a: 10, b: 0,
        ...
        { t: "Absagen und sitzen bleiben", m: 30, l: 5, a: -10, b: 0,
        ...
        { t: "Fragen, ob es die Strecke auch kürzer gibt", m: 35, l: -5, a: -5, b: 0,
...
},
{
    ...
    opts: [
        { t: "Sachlich richtigstellen, was besprochen wurde", m: 20, l: -5, a: 5, b: 5,
        ...
        { t: "Nicht antworten", m: 5, l: 10, a: 0, b: 5,
        ...
        { t: "Die Mail an Frau Elster weiterleiten", m: 15, l: -5, a: -5, b: 0,
          rep: { "Frau Elster": 5 },
...
},
{
    ...
    opts: [
        { t: "Zu Kevin und Chantal setzen", m: 30, l: 0, a: -10, b: 0,
        ...
        { t: "Sich an den Vorstandstisch setzen", m: 35, l: -5, a: 5, b: -10,
        ...
        { t: "Das Tablett nehmen und am Platz essen", m: 20, l: 10, a: 5, b: 0,
