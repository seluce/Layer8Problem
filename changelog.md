...
Maintenance, and one achievement that could not be earned.
...
* Using an item shows what it did on every bar it moves. Only the boss radar had a floating number, and exactly one item raises it - so for every other item the bar simply dropped with nothing to say it had.
...
* The evening itself got denser. The smokers' corner remembers something about 2019 - and standing there in silence is still an option, on purpose. Egon runs a late-night taxi service, the mirror ritual in the washroom gained a participant, and an escape across the car park now ends the way Chantal decides. Two scenes found their missing portraits, and the hub now tells its evening in four stages instead of three.
