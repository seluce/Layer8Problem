...
* In der Steam-Fassung liest die Freundesliste jetzt jeder in seiner eigenen Sprache. Bisher stand dort die Sprache des Spielers - wer auf Deutsch spielte, war auch für englische Freunde am Kaffeeholen. Was Steam anzeigt, entscheidet jetzt der, der hinsieht.
...
* Wer einen Tag fortsetzt, der vor einem Update gespeichert wurde, las im Protokoll die Version von damals - während die Kopfzeile des Terminals daneben die neue nannte. Die Startzeile gehört der laufenden Sitzung, nicht dem Spielstand, und nennt jetzt in beiden Fällen dieselbe Version. Der Rest des Protokolls bleibt unangetastet: was einmal dasteht, ist Gedächtnis.
