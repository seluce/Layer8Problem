...
* Bilder stehen beim Öffnen sofort da, statt einen Moment auf sich warten zu lassen - im Archiv, im Team, auf den Ereignis-Karten und im Rucksack. Die Dateien werden jetzt beim Start geholt und entpackt statt erst beim Aufschlagen des Fensters: in der Steam-Fassung sofort, weil sie ohnehin auf der Platte liegen, im Browser in einer ruhigen Minute, damit sie den Spieldaten nicht die Leitung wegnehmen.
* Im Messenger sind die Handlungs-Knöpfe kürzer geworden. Wer etwas tut, statt zu schreiben, sah bisher "[System: Chat stummschalten und archivieren]" - jetzt steht dort "[Chat stummschalten und archivieren]". Die eckigen Klammern sagen ohnehin schon, dass es keine Nachricht ist, und im schmalen Chatfenster sind acht Zeichen eine Menge. In den Chat-Blasen bleibt die Systemmeldung, wie sie war.
