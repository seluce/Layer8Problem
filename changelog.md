...
* Der Morgen entscheidet mehr als bisher. Neben Ärger, Chef-Aufmerksamkeit und Verschlafen gibt es jetzt vier weitere Arten, in den Tag zu starten: Tickets, die über Nacht aufgelaufen sind, ein gestrichenes Kontingent an Ausreden (Compliance-Woche, Gabis Frühwarnung, Kevins Mitschrift), eine Ausrede extra, wenn das Haus ausnahmsweise für dich spielt - und der seltene Morgen, an dem alles passt und man um 7:30 im leeren Büro steht. Vierundzwanzig neue Morgentexte, und die Werte richten sich jetzt nach dem Wochentag: Freitag verzeiht, Montag nicht.
